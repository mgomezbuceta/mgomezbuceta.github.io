...
<head>
	<meta charset="utf-8" />
	<title>Marcos Gómez Buceta - About Me</title>
	...
	<meta name="description" content="I am a web development technician and IT systems administrator. My passion is my work and this is the starting point." />
	<link rel="canonical" href="https://mgomezbuceta.com" />

	<!-- Twitter data -->
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:site" content="@mgomezbuceta">
	<meta name="twitter:title" content="Marcos Gómez Buceta - About me">
	<meta name="twitter:description" content="I am a web development technician and IT systems administrator. The best thing about this job is that it allows me to provide solutions to the problems that our clients pose to us, letting my imagination fly to choose the most appropriate, optimal and attractive solution.">
	<meta name="twitter:image" content="assets/img/profile-pic-bn.png">

	<!-- Open Graph data -->
	<meta property="og:title" content="Marcos Gómez Buceta - About me" />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="https://mgomezbuceta.com" />
	<meta property="og:image" content="assets/img/profile-pic-bn.png" />
	<meta property="og:description" content="I am a web development technician and IT systems administrator. The best thing about this job is that it allows me to provide solutions to the problems that our clients pose to us, letting my imagination fly to choose the most appropriate, optimal and attractive solution." />
	...
	<!-- Hotjar Tracking Code for https://mgomezbuceta.com/ -->
		<script>
...
<body class="bg-triangles">
				...
				<aside class="col-12 col-md-12 col-xl-3">
					<div class="sidebar box shadow pb-0 sticky-column">
						<svg class="avatar avatar--180" viewBox="0 0 188 188">
							<g class="avatar__box">
								<image xlink:href="assets/img/profile-pic.png" height="100%" width="100%" alt="Imagen de perfil" />
							</g>
						</svg>
						<div class="text-center">
							<h3 class="title title--h3 sidebar__user-name"><span class="weight--500">Marcos</span> Gómez Buceta
							</h3>
							<div class="badge badge--dark">Development Technician</div>

							<!-- Social -->
							<div class="social">
								<a class="social__link" href="https://twitter.com/mgomezbuceta" title="twitter"><i class="font-icon icon-twitter"></i></a>
								<a class="social__link" href="https://www.linkedin.com/in/mgomezbuceta/" title="linkedin"><i class="font-icon icon-linkedin2"></i></a>
							</div>
						</div>
						...
						<div class="sidebar__info box-inner box-inner--rounded">
							<ul class="contacts-block">
								<li class="contacts-block__item" data-toggle="tooltip" data-placement="top" title="Birthday">
									<i class="font-icon icon-calendar"></i>February 11, 1979
								</li>
								<li class="contacts-block__item" data-toggle="tooltip" data-placement="top" title="Address">
									<i class="font-icon icon-location"></i>Brión, Á Coruña, Spain
								</li>
								<li class="contacts-block__item" data-toggle="tooltip" data-placement="top" title="E-mail">
									<a href="mailto:mgomezbuceta@gmail.com"><i class="font-icon icon-envelope"></i>mgomezbuceta@gmail.com</a>
								</li>
							</ul>
							<a class="btn" href="cv-mgb.pdf" download="CV - Marcos Gomez Buceta.pdf"><i class="font-icon icon-download"></i> Download CV</a>
						</div>
					</div>
				</aside>
						...
						<div class="content">
							<div id="about-tab" class="tabcontent active">
								...
								<div class="pb-0 pb-sm-2">
									...
									<p>I am a web development technician and IT systems administrator. The best thing about this job is that it allows me to provide solutions to the problems that our clients pose to us, letting my imagination fly to choose the most appropriate, optimal and attractive solution.</p>
									<p>My passion is my work and this is the starting point, so whatever you do, do it with interest and dedication.</p>
								</div>
								...
								<div class="box-inner pb-0">
									...
									<div class="row">
										...
										<div class="col-12 col-lg-6">
											<div class="case-item box box__second">
												...
												<div>
													...
													<p class="case-item__caption">Professional development of APIs for applications (iOS and Android).</p>
												</div>
											</div>
										</div>
										<!-- Case Item -->
										<div class="col-12 col-lg-6">
											<div class="case-item box box__second">
												<img class="case-item__icon" src="assets/icons/dark/icon-database.svg" alt="" />
												<div>
													<h3 class="title title--h5">Database Design</h3>
													<p class="case-item__caption">From data modeling, database design, analysis techniques and object-oriented design to database administration.</p>
												</div>
											</div>
										</div>
										<!-- Case Item -->
										<div class="col-12 col-lg-6">
											<div class="case-item box box__second">
												<img class="case-item__icon" src="assets/icons/dark/icon-server.svg" alt="" />
												<div>
													<h3 class="title title--h5">Manage Computer System</h3>
													<p class="case-item__caption">Diagnosis of hardware and software problems, equipment configuration, design and analysis of computer ecosystem structures.</p>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-12 col-lg-6">
											...
											<div class="timeline">
												...
												<article class="timeline__item">
													<h5 class="title title--h5 timeline__title">IES San Clemente</h5>
													<span class="timeline__period">2006 — 2008</span>
													<p class="timeline__description">Higher Technician Degree in Information Systems Administration.</p>
												</article>

												<!-- Item -->
												<article class="timeline__item">
													<h5 class="title title--h5 timeline__title">University of Santiago de Compostela</h5>
													<span class="timeline__period">2005 — 2005</span>
													<p class="timeline__description">CAP (Certificate of Pedagogical Skills).</p>
												</article>

												<!-- Item -->
												<article class="timeline__item">
													<h5 class="title title--h5 timeline__title">University of Santiago de Compostela</h5>
													<span class="timeline__period">1998 — 2004</span>
													<p class="timeline__description">Master in Geography.</p>
												</article>
											</div>
										</div>
										...
										<div class="col-12 col-lg-6">
											...
											<div class="timeline">
												<!-- Item -->
												<article class="timeline__item">
													<h5 class="title title--h5 timeline__title">Development Technician</h5>
													<span class="timeline__period">2017 — Present</span>
													<p class="timeline__description">Company: Soluciones y Proyectos de Informacion SL</p>
												</article>
												...
												<!-- Item -->
												<article class="timeline__item">
													<h5 class="title title--h5 timeline__title">Senior PHP Developer</h5>
													<span class="timeline__period">2009 — 2014</span>
													<p class="timeline__description">Company: Primate Multimedia Iberica SL </p>
												</article>

												<!-- Item -->
												<article class="timeline__item">
													<h5 class="title title--h5 timeline__title">PHP developer</h5>
													<span class="timeline__period">2009 — 2009</span>
													<p class="timeline__description">Company: LPS Software y Soluciones TI</p>
												</article>
											</div>
										</div>
									</div>
									...
									<div class="row">
											...
											<div class="box box__second">
												...
												<div class="progress">
													<div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
														<div class="progress-text"><span>Web Design</span><span>85%</span></div>
													</div>
												...
												<div class="progress">
													<div class="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
														<div class="progress-text"><span>Database Design</span><span>100%</span>
														</div>
													</div>
													<div class="progress-text"><span>Database Design</span></div>
												</div>
											</div>
										</div>
										...
										<div class="col-12 col-lg-6 mt-4 mt-lg-0">
											...
											<div class="box box__second">
												...
												<div class="progress">
													<div class="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
														<div class="progress-text"><span>PHP</span><span>100%</span></div>
													</div>
									...
									<div class="gallery-grid js-masonry js-filter-container">
										...
										<figure class="gallery-grid__item category-concept">
											<div class="gallery-grid__image-wrap">
												<img class="gallery-grid__image cover lazyload" src="assets/img/picture-1.png" data-zoom alt="" />
											</div>
								...
								<div class="news-grid pb-0">
									...
									<article class="news-item box">
										<div class="news-item__image-wrap overlay overlay--45">
											...
											<img class="cover lazyload" src="assets/img/picture-1.png" alt="" />
										</div>
									...
									<article class="news-item box">
										...
										<div class="news-item__caption">
											...
											<p>Maxime placeat, sed do eiusmod tempor incididunt ut labore et dolore magna
												aliqua.</p>
										</div>
									</article>
	...
	<!-- reCAPTCHA v3 -->
	<script src="https://www.google.com/recaptcha/api.js?render=6LcrTJ0aAAAAAOPHTepGCTq1jbHixLLDWDgiDcVq"></script>
